        ...
        <section class="">
            <header class="n-bar">
                ...
                <div class="ml:3 d:flex">
                    <RouterLink to="./menus/new" class="n-icon n-icon:plus n-btn n-btn:rounded n-btn-size:small">추가
                    </RouterLink>
                </div>
            </header>
                        ...
                        <tr class="vertical-align:middle">
                            ...
                            <td>
                                <span class="d:inline-flex align-items:center">
                                    ...
                                    <RouterLink :to="`./menus/${m.id}/edit`"
                                        class="n-icon n-icon:edit_square n-icon-color:base-6">수정</RouterLink>
...
*/-->
                                            ...
                                            <dd class="ml:1"
                                                th:text="${#dates.format(m.regDate, 'yyyy-MM-dd a HH:mm')}">{{ m.regDate
                                                }}</dd>
                                        </div>
                                    </dl>
