                        ...
                        <tr class="vertical-align:middle">
                            ...
                            <td>
                                <span class="d:inline-flex align-items:center">
                                    ...
                                    <RouterLink :to="`./menus/${m.id}/edit`" class="n-icon n-icon:edit_square n-icon-color:base-6" >수정</RouterLink>
...
*/-->
                                            <dd class="ml:1" th:text="${#numbers.formatInteger(m.price,3,'COMMA')}+'원'">
                                                {{ m.price.toLocaleString('ko-KR') }}원</dd>
                                        </div>
                                        <div>
                                            <dt>등록일자</dt>
                                            <!--/*
...
*/-->
                                            ...
                                            <dd class="ml:1"
                                                th:text="${#dates.format(m.regDate, 'yyyy-MM-dd a HH:mm')}">{{ m.regDate }}</dd>
                                        </div>
                                    </dl>
                ...
                <div class="mt:4 text-align:center">
                    <ul class="n-bar">
                        <li>
                            <RouterLink @click="pageClickHandler(startNum-1)" class="n-btn" :to="`./menus?p=${startNum-1 < 1? 1 : startNum-1}`">이전</RouterLink>
                        </li>
                        <li v-for="p in pageNumbers" :key="p">
                            <RouterLink @click="pageClickHandler(p)" class="n-btn" :class="{ active: p == (useRoute().query.p || 1) }"
                                :to="`./menus?p=${p}`">{{ p }}</RouterLink>
                        </li>
                        <li>
                            <RouterLink @click="pageClickHandler(startNum+5)" class="n-btn" :to="`./menus?p=${startNum+5 > totalPages? totalPages : startNum+5}`">다음</RouterLink>
                        </li>
                    </ul>
                </div>
            </section>
